...
public class TestUtils {
    ...
    public static void assertEqualInventoryReportDate(
        ...
        Assert.assertEquals(expectedInventoryReportData.getBrand(), actualInventoryReportData.getBrand());
        Assert.assertEquals(expectedInventoryReportData.getCategory(), actualInventoryReportData.getCategory());
        Assert.assertEquals(expectedInventoryReportData.getQuantity(), actualInventoryReportData.getQuantity());
    }
    ...
    public static void assertEqualPerDaySale(PerDaySale expectedItem, PerDaySaleData actualItem) {
        Assert.assertEquals(expectedItem.getDate().toLocalDate(), actualItem.getDate());
        Assert.assertEquals(expectedItem.getOrderCount(), actualItem.getOrdersCount());
        Assert.assertEquals(expectedItem.getUniqueItemCount(), actualItem.getItemsCount());
        Assert.assertEquals(expectedItem.getTotalRevenue(), actualItem.getTotalRevenue());
    }
